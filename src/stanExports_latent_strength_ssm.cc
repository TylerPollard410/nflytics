...
#include "stanExports_latent_strength_ssm.h"

RCPP_MODULE(stan_fit4latent_strength_ssm_mod) {


    class_<rstan::stan_fit<stan_model, stan::rng_t> >("rstantools_model_latent_strength_ssm")
